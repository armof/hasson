...
local hasson = io.open("hasson", 'w')
hasson:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 hasson.lua
done
]])
hasson:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S hasson -X kill
screen -S hasson ./hasson
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x hasson;chmod +x Run;./Run')
end
...
hasson = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..hasson)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=hasson,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,2004406516}  
...
Status = 0
DevelopersQ = Redis:sismember(hasson.."hasson:DevelopersQ:Groups",UserId) 
if UserId == 2004406516 then
Status = true
elseif UserId == 296369326 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == hasson then
Status = true
...
Status = 0
Developers = Redis:sismember(hasson.."hasson:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(hasson.."hasson:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(hasson.."hasson:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(hasson.."hasson:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(hasson.."hasson:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(hasson.."hasson:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(hasson.."hasson:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 2004406516 then
Status = 'مبرمج السورس'
elseif UserId == 2004406516 then
Status = 'مبرمج السورس'
elseif UserId == Sudo_Id then  
...
Status = Redis:get(hasson.."hasson:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasics then
Status = Redis:get(hasson.."hasson:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(hasson.."hasson:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(hasson.."hasson:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(hasson.."hasson:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(hasson.."hasson:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(hasson.."hasson:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(hasson.."hasson:lockpin"..ChatId) then    
lock_pin = "✅"
else 
lock_pin = "❌"    
end
if Redis:get(hasson.."hasson:Lock:tagservr"..ChatId) then    
lock_tagservr = "✅"
else 
lock_tagservr = "❌"
end
if Redis:get(hasson.."hasson:Lock:text"..ChatId) then    
lock_text = "✅"
else 
lock_text = "❌ "    
end
if Redis:get(hasson.."hasson:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✅"
else 
lock_add = "❌ "    
end    
if Redis:get(hasson.."hasson:Lock:Join"..ChatId) == "kick" then
lock_join = "✅"
else 
lock_join = "❌ "    
end    
if Redis:get(hasson.."hasson:Lock:edit"..ChatId) then    
lock_edit = "✅"
else 
lock_edit = "❌ "    
end
if Redis:get(hasson.."hasson:Chek:Welcome"..ChatId) then
welcome = "✅"
else 
welcome = "❌ "    
end
if Redis:hget(hasson.."hasson:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(hasson.."hasson:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(hasson.."hasson:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(hasson.."hasson:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✅"
else     
flood = "❌ "     
end
if Redis:get(hasson.."hasson:Lock:Photo"..ChatId) == "del" then
lock_photo = "✅" 
elseif Redis:get(hasson.."hasson:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(hasson.."hasson:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(hasson.."hasson:Lock:Contact"..ChatId) == "del" then
lock_phon = "✅" 
elseif Redis:get(hasson.."hasson:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(hasson.."hasson:Lock:Link"..ChatId) == "del" then
lock_links = "✅"
elseif Redis:get(hasson.."hasson:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(hasson.."hasson:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✅"
elseif Redis:get(hasson.."hasson:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(hasson.."hasson:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(hasson.."hasson:Lock:User:Name"..ChatId) == "del" then
lock_user = "✅"
elseif Redis:get(hasson.."hasson:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(hasson.."hasson:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✅"
elseif Redis:get(hasson.."hasson:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(hasson.."hasson:Lock:vico"..ChatId) == "del" then
lock_muse = "✅"
elseif Redis:get(hasson.."hasson:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(hasson.."hasson:Lock:Video"..ChatId) == "del" then
lock_ved = "✅"
elseif Redis:get(hasson.."hasson:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(hasson.."hasson:Lock:Animation"..ChatId) == "del" then
lock_gif = "✅"
elseif Redis:get(hasson.."hasson:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(hasson.."hasson:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✅"
elseif Redis:get(hasson.."hasson:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(hasson.."hasson:Lock:geam"..ChatId) == "del" then
lock_geam = "✅"
elseif Redis:get(hasson.."hasson:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(hasson.."hasson:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✅"
elseif Redis:get(hasson.."hasson:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(hasson.."hasson:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(hasson.."hasson:Lock:forward"..ChatId) == "del" then
lock_fwd = "✅"
elseif Redis:get(hasson.."hasson:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(hasson.."hasson:Lock:Document"..ChatId) == "del" then
lock_file = "✅"
elseif Redis:get(hasson.."hasson:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(hasson.."hasson:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✅"
elseif Redis:get(hasson.."hasson:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(hasson.."hasson:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✅"
elseif Redis:get(hasson.."hasson:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(hasson.."hasson:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(hasson.."hasson:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✅"
elseif Redis:get(hasson.."hasson:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(hasson.."hasson:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✅"
elseif Redis:get(hasson.."hasson:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(hasson.."hasson:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(hasson.."hasson:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(hasson.."hasson:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(hasson.."hasson:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(hasson.."hasson:SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[- -『 𝘽,𝙍,𝘼 Source』 .](https://t.me/JJJJDJ)\n*ٴ•━━━━━━𝘽,𝙍,𝘼━━━━━━━•ٴ\n⌔︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⌔︙خاصيه المسح *',
unLock   = '[- -『 𝘽,𝙍,𝘼 Source』 .](https://t.me/JJJJDJ)\n*ٴ•━━━━━━𝘽,𝙍,𝘼━━━━━━━•ٴ\n⌔︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[- -『 𝘽,𝙍,𝘼 Source』 .](https://t.me/JJJJDJ)\n*ٴ•━━━━━━𝘽,𝙍,𝘼━━━━━━━•ٴ\n⌔︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⌔︙خاصيه الكتم *',
lockKid  = '[- -『 𝘽,𝙍,𝘼 Source』 .](https://t.me/JJJJDJ)\n*ٴ•━━━━━━𝘽,𝙍,𝘼━━━━━━━•ٴ\n⌔︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⌔︙خاصيه التقييد *',
lockKick = '[- -『 𝘽,𝙍,𝘼 Source』 .](https://t.me/JJJJDJ)\n*ٴ•━━━━━━𝘽,𝙍,𝘼━━━━━━━•ٴ\n⌔︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⌔︙خاصيه الطرد *',
Reply    = '[- -『 𝘽,𝙍,𝘼 Source』 .](https://t.me/JJJJDJ)\n*ٴ•━━━━━━𝘽,𝙍,𝘼━━━━━━━•ٴ\n⌔︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,hasson).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(hasson..'hasson:Channel:Join')
if Channel then
...
if tonumber(msg.sender.user_id) == tonumber(hasson) then
...
elseif tonumber(msg.sender.user_id) == 2004406516 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(hasson.."hasson:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(hasson.."hasson:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(hasson.."hasson:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(hasson.."hasson:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(hasson.."hasson:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي ⭐'
elseif Redis:sismember(hasson.."hasson:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(hasson.."hasson:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(hasson.."hasson:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(hasson.."hasson:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(hasson.."hasson:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(hasson.."hasson:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(hasson.."hasson:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(hasson.."hasson:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(hasson) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(hasson.."hasson:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(hasson.."hasson:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(hasson.."hasson:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(hasson.."hasson:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(hasson.."hasson:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(hasson) then
return false
end
local floods = Redis:hget(hasson.."hasson:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(hasson.."hasson:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(hasson.."hasson:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(hasson.."hasson:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(hasson.."hasson:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(hasson.."hasson:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(hasson.."hasson:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(hasson.."hasson:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(hasson.."hasson:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(hasson.."hasson:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(hasson.."hasson:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(hasson.."hasson:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(hasson.."hasson:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(hasson.."hasson:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(hasson.."hasson:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(hasson.."hasson:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(hasson.."hasson:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(hasson.."hasson:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(hasson.."hasson:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(hasson.."hasson:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(hasson.."hasson:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(hasson.."hasson:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(hasson.."hasson:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(hasson.."hasson:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(hasson.."hasson:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(hasson.."hasson:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(hasson.."hasson:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(hasson.."hasson:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(hasson.."hasson:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(hasson.."hasson:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(hasson.."hasson:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(hasson.."hasson:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(hasson.."hasson:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(hasson.."hasson:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(hasson.."hasson:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(hasson.."hasson:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(hasson.."hasson:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(hasson.."hasson:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(hasson.."hasson:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(hasson.."hasson:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(hasson..'hasson:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(hasson.."hasson:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(hasson.."hasson:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(hasson.."hasson:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(hasson.."hasson:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(hasson.."hasson:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(hasson.."hasson:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(hasson.."hasson:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(hasson.."hasson:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(hasson..'hasson:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︙ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(hasson..'hasson:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(hasson.."hasson:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(hasson.."hasson:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(hasson.."hasson:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(hasson..'hasson:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︙تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(hasson..'hasson:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(hasson.."hasson:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(hasson.."hasson:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(hasson.."hasson:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(hasson.."hasson:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(hasson.."hasson:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(hasson.."hasson:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(hasson.."hasson:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(hasson.."hasson:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(hasson..'hasson:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(hasson.."hasson:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(hasson.."hasson:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(hasson.."hasson:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(hasson.."hasson:Command:List:Group"..msg_chat_id,text)
...
Redis:del(hasson.."hasson:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(hasson.."hasson:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(hasson.."hasson:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(hasson.."hasson:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(hasson.."hasson:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(hasson.."hasson:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(hasson.."hasson:Command:Reids:Group:New"..msg_chat_id)
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(hasson.."hasson:Command:List:Group"..msg_chat_id,text)
Redis:del(hasson.."hasson:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(hasson.."hasson:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(hasson.."hasson:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم الغاء حفظ الرابط","md",true)         
end
if text and text:match("(https://telegram.me/)") or text and text:match("(https://t.me/)") then     
local LinkGroup = text:match("(https://telegram.me/)") or text:match("(https://t.me/)")   
Redis:set(hasson.."hasson:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(hasson.."hasson:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(hasson.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(hasson.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(hasson.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(hasson.."hasson:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(hasson.."hasson:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(hasson.."hasson:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(hasson.."hasson:Group:Rules" .. msg_chat_id,text) 
Redis:del(hasson.."hasson:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(hasson.."hasson:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(hasson.."hasson:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(hasson.."hasson:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(hasson.."hasson:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(hasson.."hasson:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(hasson.."hasson:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(hasson.."hasson:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(hasson.."hasson:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(hasson.."hasson:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(hasson.."hasson:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(hasson.."hasson:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(hasson.."hasson:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(hasson.."hasson:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(hasson.."hasson:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم حفظ رد للمدير بنجاح \n⌔︙ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(hasson.."hasson:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(hasson.."hasson:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(hasson.."hasson:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(hasson.."hasson:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(hasson.."hasson:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(hasson.."hasson:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(hasson.."hasson:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(hasson.."hasson:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(hasson.."hasson:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(hasson.."hasson:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(hasson.."hasson:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(hasson.."hasson:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(hasson.."hasson:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(hasson.."hasson:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(hasson.."hasson:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(hasson.."hasson:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(hasson.."hasson:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(hasson.."hasson:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(hasson.."hasson:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(hasson.."hasson:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(hasson.."hasson:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(hasson.."hasson:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(hasson.."hasson:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(hasson.."hasson:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(hasson.."hasson:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(hasson.."hasson:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(hasson.."hasson:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(hasson.."hasson:Add:Rd:Sudo:Video"..text)
local document = Redis:get(hasson.."hasson:Add:Rd:Sudo:File"..text)
local audio = Redis:get(hasson.."hasson:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(hasson.."hasson:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(hasson..'hasson:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(hasson..'hasson:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(hasson.."hasson:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(hasson.."hasson:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(hasson.."hasson:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(hasson.."hasson:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(hasson.."hasson:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(hasson.."hasson:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(hasson.."hasson:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(hasson.."hasson:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(hasson.."hasson:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(hasson.."hasson:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(hasson..'hasson:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(hasson.."hasson:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(hasson.."hasson:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(hasson.."hasson:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(hasson.."hasson:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(hasson.."hasson:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(hasson.."hasson:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(hasson.."hasson:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(hasson.."hasson:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(hasson.."hasson:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(hasson.."hasson:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(hasson.."hasson:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(hasson.."hasson:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(hasson.."hasson:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(hasson.."hasson:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(hasson.."hasson:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(hasson.."hasson:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(hasson.."hasson:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(hasson..'hasson:'..v..text)
end
Redis:del(hasson.."hasson:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(hasson.."hasson:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(hasson.."hasson:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(hasson.."hasson:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(hasson.."hasson:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(hasson.."hasson:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(hasson.."hasson:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(hasson.."hasson:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(hasson.."hasson:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(hasson.."hasson:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(hasson.."hasson:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(hasson.."hasson:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(hasson.."hasson:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(hasson.."hasson:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(hasson.."hasson:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(hasson.."hasson:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(hasson..'hasson:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(hasson.."hasson:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(hasson.."hasson:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(hasson.."hasson:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(hasson.."hasson:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(hasson.."hasson:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(hasson.."hasson:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(hasson.."hasson:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(hasson..'hasson:GetTexting:Devhasson'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(hasson..'hasson:GetTexting:Devhasson'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم الغاء حفظ كليشة المطور')
end
Redis:set(hasson..'hasson:Texting:Devhasson',text)
Redis:del(hasson..'hasson:GetTexting:Devhasson'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم حفظ كليشة المطور')
end
if Redis:get(hasson.."hasson:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء امر تعين الايدي","md",true)  
Redis:del(hasson.."hasson:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(hasson.."hasson:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(hasson.."hasson:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(hasson.."hasson:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(hasson.."hasson:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(hasson.."hasson:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(hasson.."hasson:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⌔︙ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(hasson.."hasson:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(hasson.."hasson:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(hasson.."hasson:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(hasson.."hasson:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⌔︙ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(hasson.."hasson:Game:Smile"..msg.chat_id) then
if text == Redis:get(hasson.."hasson:Game:Smile"..msg.chat_id) then
Redis:incrby(hasson.."hasson:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(hasson.."hasson:Game:Smile"..msg.chat_id)
...
if Redis:get(hasson.."hasson:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(hasson.."hasson:Game:Monotonous"..msg.chat_id) then
Redis:del(hasson.."hasson:Game:Monotonous"..msg.chat_id)
Redis:incrby(hasson.."hasson:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(hasson.."hasson:Game:Riddles"..msg.chat_id) then
if text == Redis:get(hasson.."hasson:Game:Riddles"..msg.chat_id) then
Redis:incrby(hasson.."hasson:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(hasson.."hasson:Game:Riddles"..msg.chat_id)
...
if Redis:get(hasson.."hasson:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(hasson.."hasson:Game:Meaningof"..msg.chat_id) then
Redis:incrby(hasson.."hasson:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(hasson.."hasson:Game:Meaningof"..msg.chat_id)
...
if Redis:get(hasson.."hasson:Game:Reflection"..msg.chat_id) then
if text == Redis:get(hasson.."hasson:Game:Reflection"..msg.chat_id) then
Redis:incrby(hasson.."hasson:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(hasson.."hasson:Game:Reflection"..msg.chat_id)
...
if Redis:get(hasson.."hasson:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(hasson.."hasson:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(hasson.."hasson:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(hasson.."hasson:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(hasson.."hasson:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(hasson.."hasson:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(hasson.."hasson:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(hasson.."hasson:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(hasson.."hasson:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(hasson.."hasson:Game:Difference"..msg.chat_id) then
if text == Redis:get(hasson.."hasson:Game:Difference"..msg.chat_id) then 
Redis:del(hasson.."hasson:Game:Difference"..msg.chat_id)
Redis:incrby(hasson.."hasson:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(hasson.."hasson:Game:Example"..msg.chat_id) then
if text == Redis:get(hasson.."hasson:Game:Example"..msg.chat_id) then 
Redis:del(hasson.."hasson:Game:Example"..msg.chat_id)
Redis:incrby(hasson.."hasson:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(hasson..'hasson:Channel:Join')}, },}}
...
if tonumber(hasson) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(hasson..'hasson:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(hasson.."hasson:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(hasson.."hasson:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(hasson.."hasson:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(hasson.."hasson:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(hasson.."hasson:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(hasson.."hasson:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(hasson) then 
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(hasson.."hasson:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(hasson.."hasson:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(hasson.."hasson:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(hasson.."hasson:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(hasson.."hasson:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(hasson..'hasson:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(hasson..'hasson:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,hasson).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︙البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(hasson..'hasson:Channel:Join',ChannelUser) 
...
Redis:set(hasson..'hasson:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(hasson..'hasson:Channel:Join')
...
--os.execute('rm -rf hasson.lua')
--download('https://raw.githubusercontent.com/armof/hasson/master/hasson.lua','hasson.lua')
...
local Groups = Redis:smembers(hasson..'hasson:ChekBotAdd')  
local UsersBot = Redis:smembers(hasson..'hasson:Num:User:Pv')  
local Get_Json = '{"BotId": '..hasson..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(hasson.."hasson:TheBasics:Group"..v)
local Constructor = Redis:smembers(hasson.."hasson:Originators:Group"..v)
local Manager = Redis:smembers(hasson.."hasson:Managers:Group"..v)
local Admin = Redis:smembers(hasson.."hasson:Addictive:Group"..v)
local Vips = Redis:smembers(hasson.."hasson:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(hasson.."hasson:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(hasson.."hasson:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(hasson.."hasson:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(hasson.."hasson:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(hasson.."hasson:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(hasson.."hasson:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(hasson.."hasson:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(hasson.."hasson:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(hasson.."hasson:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(hasson.."hasson:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(hasson.."hasson:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(hasson.."hasson:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(hasson.."hasson:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(hasson.."hasson:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(hasson.."hasson:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(hasson.."hasson:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(hasson.."hasson:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(hasson.."hasson:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(hasson.."hasson:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(hasson.."hasson:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(hasson.."hasson:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(hasson..'hasson:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*⌔︙عدد احصائيات البوت الكامله \nٴ•━━━━━━𝘽,𝙍,𝘼━━━━━━━•ٴ\n⌔︙عدد المجموعات : '..(Redis:scard(hasson..'hasson:ChekBotAdd') or 0)..'\n⌔︙عدد المشتركين : '..(Redis:scard(hasson..'hasson:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(hasson.."hasson:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(hasson..'hasson:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(hasson..'hasson:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(hasson.."hasson:ChekBotAdd",msg_chat_id)
Redis:set(hasson.."hasson:Status:Id"..msg_chat_id,true) ;Redis:set(hasson.."hasson:Status:Reply"..msg_chat_id,true) ;Redis:set(hasson.."hasson:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(hasson.."hasson:Status:BanId"..msg_chat_id,true) ;Redis:set(hasson.."hasson:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(hasson.."hasson:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(hasson.."hasson:ChekBotAdd",msg_chat_id) then
...
Redis:srem(hasson.."hasson:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(hasson.."hasson:ChekBotAdd",msg_chat_id) then
Redis:incr(hasson..'hasson:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
if text == "ايدي" and msg.reply_to_message_id == 0 then
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(hasson..'hasson:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⌔︙عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end 
if not Redis:get(hasson.."hasson:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(hasson..'hasson:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(hasson..'hasson:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(hasson.."hasson:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(hasson.."hasson:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(hasson.."hasson:Set:Id:Group"..msg_chat_id)
if Redis:get(hasson.."hasson:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(hasson..'hasson:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(hasson..'hasson:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*⌔︙ايديه : '..UserId..
...
local TotalMsg = Redis:get(hasson..'hasson:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(hasson..'hasson:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*⌔︙ايديه : '..UserId..
'\n⌔︙معرفه : @'..UserName..
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,hasson).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,hasson).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✅ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(hasson.."hasson:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(hasson.."hasson:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(hasson.."hasson:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(hasson.."hasson:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(hasson.."hasson:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(hasson.."hasson:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(hasson.."hasson:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(hasson.."hasson:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(hasson.."hasson:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(hasson.."hasson:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(hasson.."hasson:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(hasson.."hasson:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(hasson.."hasson:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(hasson.."hasson:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(hasson.."hasson:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(hasson.."hasson:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(hasson.."hasson:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(hasson.."hasson:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(hasson.."hasson:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(hasson.."hasson:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(hasson.."hasson:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(hasson.."hasson:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:Developers:Groups",UserId) 
...
if not Redis:sismember(hasson.."hasson:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(hasson.."hasson:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(hasson.."hasson:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(hasson.."hasson:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(hasson.."hasson:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(hasson.."hasson:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(hasson.."hasson:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(hasson.."hasson:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(hasson.."hasson:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(hasson.."hasson:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(hasson.."hasson:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(hasson.."hasson:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(hasson.."hasson:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(hasson.."hasson:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(hasson.."hasson:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(hasson.."hasson:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(hasson.."hasson:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(hasson.."hasson:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(hasson.."hasson:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(hasson.."hasson:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(hasson.."hasson:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(hasson.."hasson:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(hasson.."hasson:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(hasson.."hasson:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Developers:Groups",UserId) 
...
if Redis:sismember(hasson.."hasson:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(hasson.."hasson:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(hasson.."hasson:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(hasson.."hasson:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(hasson.."hasson:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(hasson.."hasson:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(hasson.."hasson:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(hasson.."hasson:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(hasson.."hasson:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(hasson.."hasson:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(hasson.."hasson:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(hasson.."hasson:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(hasson.."hasson:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*⌔︙قائمه مطورين البوت \n ٴ•━━━━━━𝘽,𝙍,𝘼━━━━━━━•ٴ*\n'
...
local Info_Members = Redis:smembers(hasson.."hasson:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(hasson.."hasson:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(hasson.."hasson:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(hasson.."hasson:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(hasson.."hasson:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(hasson.."hasson:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(hasson.."hasson:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(hasson.."hasson:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(hasson.."hasson:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(hasson.."hasson:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(hasson.."hasson:Status:Id"..msg_chat_id,true) 
...
Redis:set(hasson.."hasson:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(hasson.."hasson:Status:Reply"..msg_chat_id,true) 
...
Redis:set(hasson.."hasson:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(hasson.."hasson:Status:BanId"..msg_chat_id,true) 
...
Redis:set(hasson.."hasson:BotFree",true) 
...
Redis:set(hasson.."hasson:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(hasson.."hasson1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(hasson.."hasson1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(hasson.."hasson1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(hasson.."hasson1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(hasson.."hasson1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(hasson..'hasson1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(hasson..'hasson1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(hasson..'hasson1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(hasson.."hasson1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(hasson.."hasson1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(hasson.."hasson1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(hasson.."hasson1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(hasson.."hasson1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(hasson.."hasson1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(hasson.."hasson1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(hasson.."hasson1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(hasson.."hasson1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(hasson.."hasson1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(hasson.."hasson1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(hasson.."hasson1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(hasson.."hasson1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(hasson.."hasson1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(hasson.."hasson1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(hasson.."hasson1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(hasson.."hasson1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(hasson.."hasson1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(hasson.."hasson1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(hasson.."hasson1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(hasson.."hasson1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(hasson.."hasson1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(hasson.."hasson1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(hasson.."hasson1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(hasson.."hasson11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(hasson.."hasson11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(hasson.."hasson11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(hasson.."hasson11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(hasson.."hasson11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(hasson..'hasson11:Add:Rd:Sudo:Text'..text)
Redis:del(hasson..'hasson11:Add:Rd:Sudo:Text1'..text)
Redis:del(hasson..'hasson11:Add:Rd:Sudo:Text2'..text)
Redis:del(hasson.."hasson11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(hasson.."hasson11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(hasson.."hasson11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(hasson.."hasson11:Add:Rd:Sudo:Text"..v) 
Redis:del(hasson.."hasson11:Add:Rd:Sudo:Text1"..v) 
Redis:del(hasson.."hasson11:Add:Rd:Sudo:Text2"..v)   
Redis:del(hasson.."hasson11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(hasson.."hasson11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(hasson.."hasson11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(hasson.."hasson11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(hasson.."hasson11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(hasson.."hasson11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(hasson.."hasson11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(hasson.."hasson11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(hasson.."hasson11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(hasson.."hasson11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(hasson.."hasson11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(hasson.."hasson11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(hasson.."hasson11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(hasson.."hasson11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(hasson.."hasson11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(hasson.."hasson11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(hasson.."hasson11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(hasson.."hasson11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(hasson.."hasson:allM"..msg.chat_id, msg.id)
if Redis:get(hasson.."hasson:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(hasson.."hasson:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(hasson.."hasson:allM"..msg.chat_id)
...
Redis:del(hasson.."hasson:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(hasson.."hasson:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(hasson.."hasson:allM"..msg.chat_id)  
...
Redis:del(hasson.."hasson:Status:Del:Media"..msg.chat_id)
...
Redis:set(hasson.."hasson:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(hasson.."hasson:Status:yt"..msg.chat_id)
...
Redis:set(hasson.."hasson:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(hasson.."hasson:Status:yt"..msg.chat_id) then
...
if TextMsg == 'الرابط' then
Redis:del(hasson.."hasson:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(hasson.."hasson:Status:Welcome"..msg_chat_id) 
...
Redis:del(hasson.."hasson:Status:Id"..msg_chat_id) 
...
Redis:del(hasson.."hasson:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(hasson.."hasson:Status:Reply"..msg_chat_id) 
...
Redis:del(hasson.."hasson:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(hasson.."hasson:Status:BanId"..msg_chat_id) 
...
Redis:del(hasson.."hasson:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(hasson.."hasson:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(hasson.."hasson:Status:KickMe"..msg_chat_id) 
...
Redis:del(hasson.."hasson:BotFree") 
...
Redis:del(hasson.."hasson:TwaslBot") 
...
if Redis:sismember(hasson.."hasson:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(hasson.."hasson:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(hasson.."hasson:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(hasson.."hasson:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(hasson.."hasson:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(hasson.."hasson:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(hasson.."hasson:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(hasson.."hasson:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(hasson.."hasson:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(hasson.."hasson:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(hasson.."hasson:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(hasson.."hasson:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(hasson.."hasson:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(hasson.."hasson:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(hasson.."hasson:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(hasson.."hasson:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(hasson.."hasson:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(hasson.."hasson:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(hasson.."hasson:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(hasson.."hasson:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(hasson.."hasson:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(hasson.."hasson:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(hasson.."hasson:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(hasson.."hasson:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(hasson.."hasson:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(hasson.."hasson:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(hasson.."hasson:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(hasson.."hasson:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(hasson.."hasson:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(hasson.."hasson:Lock:text"..msg_chat_id,true) 
...
Redis:set(hasson.."hasson:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(hasson.."hasson:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(hasson.."hasson:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(hasson.."hasson:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(hasson.."hasson:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(hasson.."hasson:Lock:edit"..msg_chat_id,true) 
...
Redis:set(hasson.."hasson:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(hasson..'hasson:'..lock..msg_chat_id,"del")    
end
...
Redis:del(hasson.."hasson:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(hasson.."hasson:Lock:text"..msg_chat_id)  
...
Redis:del(hasson.."hasson:Lock:Join"..msg_chat_id)  
...
Redis:del(hasson.."hasson:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(hasson.."hasson:Lock:tagservr"..msg_chat_id)  
...
Redis:del(hasson.."hasson:lockpin"..msg_chat_id)  
...
Redis:del(hasson.."hasson:Lock:edit"..msg_chat_id) 
...
Redis:del(hasson.."hasson:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(hasson..'hasson:'..lock..msg_chat_id)    
end
...
Redis:hset(hasson.."hasson:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(hasson.."hasson:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(hasson.."hasson:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(hasson.."hasson:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(hasson.."hasson:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(hasson.."hasson:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:Link"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:User:Name"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:hashtak"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:Cmd"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:Photo"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:Video"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:Animation"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:geam"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:Audio"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:vico"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:Sticker"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:forward"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:Document"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:Contact"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:Spam"..msg_chat_id)  
...
Redis:set(hasson.."hasson:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(hasson.."hasson:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(hasson.."hasson:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(hasson.."hasson:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(hasson.."hasson:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(hasson.."hasson:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(hasson.."hasson:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(hasson.."hasson:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(hasson.."hasson:Group:Link"..msg_chat_id) 
if GetLink then
...
Redis:setex(hasson.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(hasson.."hasson:Status:Welcome"..msg_chat_id) then
...
Redis:del(hasson.."hasson:Welcome:Group"..msg_chat_id) 
...
Redis:setex(hasson.."hasson:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(hasson.."hasson:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(hasson.."hasson:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(hasson.."hasson:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(hasson.."hasson:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(hasson.."hasson:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(hasson.."hasson:Filter:Group:"..v..msg_chat_id)  
Redis:srem(hasson.."hasson:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(hasson.."hasson:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(hasson..'hasson:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(hasson..'hasson:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔︙ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(hasson.."hasson:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(hasson.."hasson:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(hasson.."hasson:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(hasson.."hasson:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(hasson.."hasson:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✅ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(hasson.."hasson:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✅ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(hasson.."hasson:Status:Id"..msg.chat_id) then
StatusId = '❬ ✅ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(hasson.."hasson:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✅ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(hasson.."hasson:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✅ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(hasson.."hasson:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✅ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(hasson.."hasson:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✅ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(hasson.."hasson:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✅ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(hasson.."hasson:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✅ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(hasson.."hasson:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✅ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(hasson.."hasson:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = 'ٴ•━━━━━━𝘽,𝙍,𝘼━━━━━━━•ٴ', url = 't.me/JJJJDJ'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(hasson.."hasson:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(hasson.."hasson:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(hasson.."hasson:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(hasson.."hasson:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(hasson.."hasson:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(hasson.."hasson:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(hasson.."hasson:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(hasson.."hasson:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(hasson.."hasson:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(hasson.."hasson:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(hasson.."hasson:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(hasson.."hasson:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(hasson..'hasson:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(hasson..'hasson:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(hasson..'hasson:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عدد رسائلك هنا *~ '..(Redis:get(hasson..'hasson:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عدد التعديلات هنا *~ '..(Redis:get(hasson..'hasson:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عدد جهاتك المضافه هنا *~ '..(Redis:get(hasson.."hasson:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(hasson.."hasson:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⌔︙ارسل الان النص
⌔︙يمكنك اضافه :
...
Redis:del(hasson.."hasson:Set:Id:Group"..msg.chat_id)
...
Redis:del(hasson.."hasson:DevelopersQ:Groups") 
...
Redis:del(hasson.."hasson:Developers:Groups") 
...
Redis:del(hasson.."hasson:TheBasics:Group"..msg_chat_id) 
...
Redis:del(hasson.."hasson:Originators:Group"..msg_chat_id) 
...
Redis:del(hasson.."hasson:Managers:Group"..msg_chat_id) 
...
Redis:del(hasson.."hasson:Addictive:Group"..msg_chat_id) 
...
Redis:del(hasson.."hasson:Distinguished:Group"..msg_chat_id) 
...
Redis:del(hasson.."hasson:BanAll:Groups") 
...
Redis:del(hasson.."hasson:BanGroup:Group"..msg_chat_id) 
...
Redis:del(hasson.."hasson:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(hasson.."hasson:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(hasson.."hasson:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(hasson.."hasson:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(hasson.."hasson:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(hasson.."hasson:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(hasson.."hasson:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(hasson.."hasson:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(hasson.."hasson:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(hasson.."hasson:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(hasson.."hasson:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(hasson.."hasson:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(hasson.."hasson:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⌔"
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(hasson.."hasson:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(hasson.."hasson:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(hasson.."hasson:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(hasson.."hasson:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(hasson.."hasson:Add:Rd:Sudo:Gif"..v)   
Redis:del(hasson.."hasson:Add:Rd:Sudo:vico"..v)   
Redis:del(hasson.."hasson:Add:Rd:Sudo:stekr"..v)     
Redis:del(hasson.."hasson:Add:Rd:Sudo:Text"..v)   
Redis:del(hasson.."hasson:Add:Rd:Sudo:Photo"..v)
Redis:del(hasson.."hasson:Add:Rd:Sudo:Video"..v)
Redis:del(hasson.."hasson:Add:Rd:Sudo:File"..v)
Redis:del(hasson.."hasson:Add:Rd:Sudo:Audio"..v)
Redis:del(hasson.."hasson:Add:Rd:Sudo:video_note"..v)
Redis:del(hasson.."hasson:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \nٴ•━━━━━━𝘽,𝙍,𝘼━━━━━━━•ٴ\n"
for k,v in pairs(list) do
if Redis:get(hasson.."hasson:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(hasson.."hasson:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(hasson.."hasson:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(hasson.."hasson:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(hasson.."hasson:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(hasson.."hasson:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(hasson.."hasson:Add:Rd:Sudo:File"..v) then
db = "ملف ⌔"
elseif Redis:get(hasson.."hasson:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(hasson.."hasson:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(hasson.."hasson:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(hasson.."hasson:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(hasson.."hasson:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(hasson.."hasson:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(hasson.."hasson:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(hasson.."hasson:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(hasson.."hasson:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(hasson..'hasson:GetTexting:Devhasson'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(hasson..'hasson:Texting:Devhasson')
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙ تم حذف كليشه المطور')
end
if text == 'المطور' or text == 'مطور' then
local TextingDevhasson = Redis:get(hasson..'hasson:Texting:Devhasson')
if TextingDevhasson then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevhasson,"md",true)  
else
...
https.request("https://api.telegram.org/bot"..Token.."/sendmessage?chat_id=" .. msg_chat_id .. "&text=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '• قناة السورس', url = 't.me/JJJJDJ'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[*
...
Redis:setex(hasson.."hasson:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(hasson.."hasson:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(hasson.."hasson:Name:Bot") or "باندا") then
local NamesBot = (Redis:get(hasson.."hasson:Name:Bot") or "باندا")
local NameBots = {
"محمد "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
x = x + 1
Redis:srem(hasson..'hasson:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,hasson)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*⌔︙البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(hasson..'hasson:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(hasson..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(hasson..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(hasson..'hasson:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(hasson.."hasson:Game:Smile"..msg.chat_id,SM)
...
Redis:set(hasson.."hasson:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(hasson.."hasson:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(hasson.."hasson:Status:Games"..msg.chat_id) then
Redis:del(hasson.."hasson:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(hasson.."hasson:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(hasson.."hasson:Status:Games"..msg.chat_id) then
Redis:del(hasson.."hasson:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(hasson.."hasson:Game:Reflection"..msg.chat_id,name)
...
Redis:set(hasson.."hasson:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(hasson.."hasson:Game:Difference"..msg.chat_id,name)
...
Redis:set(hasson.."hasson:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(hasson.."hasson:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(hasson.."hasson:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(hasson.."hasson:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(hasson.."hasson:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(hasson.."hasson:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(hasson.."hasson:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(hasson.."hasson:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
if text == '/start' then
Redis:sadd(hasson..'hasson:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(hasson.."hasson:Start:Bot") then
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(hasson.."hasson:Name:Bot") or "باندا")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(hasson.."hasson:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(hasson.."hasson:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(hasson.."hasson:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(hasson.."hasson:TwaslBot") and not Redis:sismember(hasson.."hasson:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(hasson.."hasson:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(hasson.."hasson:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(hasson..'hasson:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'⌔︙تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(hasson..'hasson:BaN:In:Tuasl',Info_User)  
...
Redis:srem(hasson.."hasson:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(hasson..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(hasson.."hasson:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(hasson.."hasson:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(hasson.."hasson:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(hasson.."hasson:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(hasson.."hasson:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(hasson.."hasson:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(hasson.."hasson:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(hasson.."hasson:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(hasson.."hasson:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(hasson.."hasson:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(hasson.."hasson:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(hasson.."hasson:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(hasson.."hasson:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(hasson.."hasson:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(hasson.."hasson:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(hasson.."hasson:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(hasson.."hasson:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(hasson.."hasson:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(hasson.."hasson:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == hasson then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(hasson..'hasson:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(hasson.."hasson:Lock:edit"..data.chat_id) then
...
Redis:incrby(hasson.."hasson:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(hasson.."hasson:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(hasson.."hasson:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(hasson.."hasson:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(hasson.."hasson:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(hasson.."hasson:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(hasson.."hasson:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(hasson.."hasson:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(hasson.."hasson:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(hasson..'hasson:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(hasson.."hasson:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"⌔︙تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(hasson.."hasson:SilentGroup:Group"..ChatId) 
